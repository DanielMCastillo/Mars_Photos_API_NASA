...
(function($) {
	...
	$(function() {
		$('.nav__menu').slicknav({
		prependTo: '.header .container-fluid',
		label: '',             // No texto en el botón hamburguesa (opcional)
		closedSymbol: '&#9658;', // Símbolo cuando está cerrado
		openedSymbol: '&#9660;'  // Símbolo cuando está abierto
		});
	});
